...
const prevVisit = Array.from(Array(100), () => new Araay(100).fill(false));
const curVisit = Array.from(Array(100), () => new Araay(100).fill(false));
const board = [
  [0, 0, 0, 1, 1],
  [0, 0, 0, 1, 0],
  [0, 1, 0, 1, 1],
...
const rootCoord = [0, 0];
const bfs = (rootCoord) => {
  prevQueue.push(rootCoord);
  visit[rootCoord[1][0]][rootCoord[1][1]] = true;
