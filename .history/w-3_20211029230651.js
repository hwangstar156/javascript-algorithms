...
const solution = (pobi, crong) => {
  const pobiLeft comparePlusAndMultiply(
    pobi[0].toString()
  );
  const pobiRight = comparePlusAndMultiply(
    pobi[1].toString()
  );
  ...
  const crongLeft = comparePlusAndMultiply(
    crong[0].toString()
  );
  const crongRight = comparePlusAndMultiply(
    crong[1].toString()
  );
